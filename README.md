...
- **La scène vocale s’adapte au nombre de joueurs** : à deux, deux sièges face à face et le buzzer entre eux. Au-delà, un tour de table — une bande de vignettes portant l’ordre de passage, les vies et le rôle du moment (au micro, peut buzzer, a proposé, éliminé), un seul panneau allumé pour le joueur qui parle, et la proposition en attente sur sa propre rangée, corrigeable jusqu’au verdict. Le buzzer reste en bas d’écran, à portée de pouce. Seul l’auteur du maillon précédent peut buzzer : la scène le nomme.
